  ...
  <div class="home-blog">
    <div class="hero" :style="{ ...bgImageStyle }">
      ...
      <ModuleTransition delay="0.04">
        <div v-if="recoShowModule && $frontmatter.heroText !== null">
          <img
            v-if="$frontmatter.showTitleImg"
            :src="$withBase($frontmatter.titleImg)"
            alt="title"
            :style="titleImgStyle || {}"
          />
          <h1 v-else>{{ $frontmatter.heroText || $title || 'vuePress-theme-reco' }}</h1>
        </div>
      </ModuleTransition>
    ...
    <ModuleTransition delay="0.24">
      <div v-show="recoShowModule" class="home-blog-wrapper">
        ...
        <div class="info-wrapper">
          <PersonalInfo />
          <h4>
            <i class="iconfont reco-category"></i> 分类
          </h4>
...
export default {
  ...
  computed: {
    ...
    titleImgStyle() {
      return (
        this.$frontmatter.titleImgStyle || {
          maxHeight: '200px',
          width: '325px',
          margin: '7em 0 2em 0'
        }
